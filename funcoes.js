...
var opcoesDeVestigios = [
    ...
    { texto: 'calçado', acao: ' típicas de calçado,', cor:'#EE82EE'},
    { texto: 'pés', acao: ' que ensejam marcas de pés', cor:'#EE82EE'},
    { texto: 'mãos', acao: ' que ensejam marcas de mãos', cor:'#EE82EE'},
    { texto: 'terra', acao: ' em terra', cor:'#EE82EE'},
    
    { texto: 'Fragmentos', acao: ' caracterizados por fragmentos caídos ao solo, a saber,', cor:'#DA70D6'},
    { texto: 'de cimento', acao: ' de cimento', cor:'#EE82EE'},
    { texto: 'de telha ', acao: ' de telha', cor:'#EE82EE'},
    { texto: 'de tijolo', acao: ' de tijolo', cor:'#EE82EE'},
    { texto: 'de vidro', acao: ' de vidro', cor:'#EE82EE'},


    { texto: 'Arrombamento', acao: 'Vestígios compatíveis com arrombamento, caracterizados por ', cor:'#32CD32'},
    { texto: 'Danos', acao: 'danos', cor:'#DA70D6'},
    { texto: 'Amolgamento', acao: ' amolgamentos', cor:'#DA70D6'},
    { texto: 'Fraturas', acao: ' fraturas', cor:'#DA70D6'},
    { texto: 'Atritamentos', acao: ' atritamentos', cor:'#DA70D6'},
    { texto: 'Remoção', acao: ' remoção', cor:'#DA70D6'},
    
    { texto: 'em porta', acao: ' em porta', cor:'#EE82EE'},
    { texto: 'em janela', acao: ' em janela', cor:'#EE82EE'},
    { texto: 'em parede', acao: ' em parede', cor:'#EE82EE'},
    { texto: 'em telhado', acao: ' em telhado', cor:'#EE82EE'},
    { texto: 'de forro', acao: ' de forro', cor:'#EE82EE'},
    { texto: 'moldura de vedação', acao: ' de moldura de vedação', cor:'#EE82EE'},
    
    { texto: 'de vidro/vidrilho', acao: ' de vidro/vidrilho', cor:'#FA8072'},
    { texto: 'de metal', acao: ' de metal', cor:'#FA8072'},
    { texto: 'de vidro e metal', acao: ' de metal', cor:'#FA8072'},
    { texto: 'de plástico', acao: ' de plástico', cor:'#FA8072'},
    { texto: 'de madeira', acao: ' de madeira', cor:'#FA8072'},

    { texto: 'alavanca', acao: ' que ensejam uso de instrumento na forma de alavanca', cor:'#FA8072'},
    { texto: 'ação percussiva', acao: ' que ensejam uso de instrumento na forma de percussiva', cor:'#FA8072'},
    { texto: 'força humana', acao: ' que ensejam emprego de força humana desassistida de instrumento', cor:'#FA8072'},
    { texto: 'alavanca', acao: ' que ensejam uso de instrumento na forma de alavanca', cor:'#FA8072'},
    { texto: 'mixa', acao: ' que ensejam uso de chave falsa ou mixa', cor:'#FA8072'},
    { texto: 'inserção de instrumento', acao: ' que ensejam inserção de instrumento incerto', cor:'#FA8072'},
    
    
    { texto: 'Desordem', acao: 'Desordem típica de busca ', cor:'#32CD32'},
    { texto: 'quartos', acao: ' nos quartos,', cor:'#EE82EE'},
    { texto: 'quarto', acao: ' no quarto,', cor:'#EE82EE'},
    { texto: 'closet', acao: ' no closet,', cor:'#EE82EE'},
    { texto: 'sala ', acao: ' na sala,', cor:'#EE82EE'},
    { texto: 'cozinha', acao: ' na cozinha,', cor:'#EE82EE'},
    { texto: 'banheiro', acao: ' no banheiro,', cor:'#EE82EE'},
    { texto: 'garagem ', acao: ' na garagem,', cor:'#EE82EE'},
    { texto: 'lavanderia', acao: ' na lavanderia,', cor:'#EE82EE'},
    { texto: 'na área externa', acao: ' na área externa,', cor:'#EE82EE'},
        
    { texto: 'Situado', acao: 'situado na porção ', cor:'#32CD32'},
    { texto: 'anterior', acao: 'anterior,', cor:'#EE82EE'},
    { texto: 'média', acao: 'média,', cor:'#EE82EE'},
    { texto: 'posterior', acao: 'posterior,', cor:'#EE82EE'},
    { texto: 'esquerda', acao: 'esquerda,', cor:'#EE82EE'},
    { texto: 'central', acao: 'central,', cor:'#EE82EE'},
    { texto: 'direita', acao: 'direita,', cor:'#EE82EE'},
    { texto: 'interna', acao: 'interna,', cor:'#EE82EE'},
    { texto: 'externa', acao: 'externa,', cor:'#EE82EE'},
    { texto: 'superior', acao: 'superior,', cor:'#EE82EE'},
    { texto: 'inferior', acao: 'inferior,', cor:'#EE82EE'},
...
var opcoesDeLocal = [
    ...
    { texto: 'Via pública', acao: 'Via pública.', cor:'#32CD32'},
    
    { texto: 'Bar', acao: 'edificação do tipo estabelecimento comercial, unido de vizinhos em ambos os lados, erguido recuado e ao nível geral da via pública, vedado do passeio público por muro de alvenaria/gradeamento metálico. Internamente era composto por um salão principal, contendo balcão mesas, cadeiras e bancos, bem como geladeiras e prateleiras.', cor:'#32CD32'},

    
    { texto: 'Residência', acao: 'edificação do tipo residência,', cor:'#E9967A'},
    { texto: 'Comércio', acao: 'edificação do tipo estabelecimento comercial,', cor:'#E9967A'},
    { texto: 'Indústria', acao: 'edificação do tipo industrial,', cor:'#E9967A'},
    { texto: 'Complexo', acao: 'complexo dotado de diversas edificações,', cor:'#E9967A'},

    { texto: 'Alvenaria', acao: ' em alvenaria,', cor:'#FA8072'},
    { texto: 'Madeira', acao: ' em madeira,', cor:'#FA8072'},
    { texto: 'Metal', acao: ' em metal,', cor:'#FA8072'},
